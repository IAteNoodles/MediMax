...
def create_comprehensive_patient():
    ...
    print("- Smoking history: Former")
    print("- BMI: 28.5")
    print("- HbA1c level: 6.2%")
    print("- Blood glucose level: 140 mg/dL")
    print("- Added 2 entries to each table as requested")

    return patient_id

if __name__ == "__main__":
    create_comprehensive_patient()